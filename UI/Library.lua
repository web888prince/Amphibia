...
local function createSlider(name, section, layoutOrder, ExplorerName)
	...
	sliderButton.Size = UDim2.new(0,265,0,36)
	...
	nameText.Name = "NameText"
	nameText.Size = UDim2.new(0,88,1,0)
	nameText.BackgroundTransparency = 1
	nameText.ZIndex = 1
	nameText.Font = Enum.Font.RobotoMono
	nameText.BorderSizePixel = 0
	...
	sliderLine.Position = UDim2.new(0.345,0,0.555,0)
	sliderLine.Size = UDim2.new(0,130,0,4)
	sliderLine.ZIndex = 1
	...
	local sliderValueShadow = Instance.new("TextLabel")
	sliderValueShadow.Parent = sliderButton
	sliderValueShadow.Name = "ValueSuffix"
	sliderValueShadow.BackgroundTransparency = 1
	sliderValueShadow.Position = UDim2.new(0.845,0,0.51,0)
	sliderValueShadow.Size = UDim2.new(0,34,0,10)
	sliderValueShadow.Font = Enum.Font.RobotoMono
	sliderValueShadow.Text = "value"
	sliderValueShadow.TextSize = 9
	sliderValueShadow.TextTransparency = 0.58
	sliderValueShadow.TextColor3 = Color3.fromRGB(255,255,255)
	sliderValueShadow.TextXAlignment = Enum.TextXAlignment.Right
...
local function buildColorPickerWindow(ColorPickerGui)
    ...
    local function createValueInput(prefix, position, parent)
        local holder = Instance.new("Frame")
        holder.Parent = parent
        holder.BackgroundTransparency = 1
        holder.Position = position
        holder.Size = UDim2.new(0,68,0,42)
        holder.Name = prefix .. "Holder"
        ...
        stroke1.Parent = box
        stroke1.Color = Color3.fromRGB(61,61,61)
        stroke1.Thickness = 2
        stroke1.ZIndex = 1
    ...
    COLORPICKER_MainFrame.ClipsDescendants = true
    ...
    COLORPICKER_WindowName.Parent = COLORPICKER_HeaderBgFrame
    COLORPICKER_WindowName.Name = "WindowName"
    COLORPICKER_WindowName.BackgroundTransparency = 1
    COLORPICKER_WindowName.Position = UDim2.new(0.016,0,0,0)
    COLORPICKER_WindowName.Size = UDim2.new(0,160,0,24)
    ...
    COLORPICKER_WindowName.ZIndex = 6

    local COLORPICKER_WindowDesc = Instance.new("TextLabel")
    COLORPICKER_WindowDesc.Parent = COLORPICKER_HeaderBgFrame
    COLORPICKER_WindowDesc.BackgroundTransparency = 1
    COLORPICKER_WindowDesc.ZIndex = 6
    COLORPICKER_WindowDesc.Position = UDim2.new(0.016,0,0.46,0)
    COLORPICKER_WindowDesc.Size = UDim2.new(0,160,0,16)
    ...
    COLORPICKER_CloseButton.Parent = COLORPICKER_HeaderBgFrame
    ...
    COLORPICKER_CloseButton.Position = UDim2.new(1,-42,0.12,0)
    ...
    COLORPICKER_CloseButton.ZIndex = 6
    ...
    COLORPICKER_ColorPickerMainFrameDot.ZIndex = 3
    ...
    COLORPICKER_ColorPickerMainFrameDotStroke1.Color = Color3.fromRGB(255,255,255)
    COLORPICKER_ColorPickerMainFrameDotStroke1.Thickness = 1
    COLORPICKER_ColorPickerMainFrameDotStroke1.Transparency = 0.15
    ...
    COLORPICKER_ColorPickerMainFrameDotStroke2.Transparency = 0.48
    ...
    COLORPICKER_ColorSelectorFrameSelectLine.BackgroundColor3 = Color3.fromRGB(245,245,245)
    COLORPICKER_ColorSelectorFrameSelectLine.Position = UDim2.new(0,0,0.74,0)
    COLORPICKER_ColorSelectorFrameSelectLine.Size = UDim2.new(0,19,0,2)
    COLORPICKER_ColorSelectorFrameSelectLine.ZIndex = 3
    ...
    COLORPICKER_LastColorRecentText.Size = UDim2.new(0,82,0,24)
    ...
    COLORPICKER_LastColorRecentText.ZIndex = 5
    ...
    COLORPICKER_ResetToDefault.ZIndex = 5
    ...
    COLORPICKER_RandomColor.ZIndex = 5
    ...
    COLORPICKER_MoveBackButton.ZIndex = 5
    ...
    COLORPICKER_MoveForwardButton.ZIndex = 5
    COLORPICKER_MoveForwardButton.BackgroundTransparency = 1

    local RGBTitle = Instance.new("TextLabel")
    RGBTitle.Parent = COLORPICKER_MainFrame
    RGBTitle.BackgroundTransparency = 1
    RGBTitle.Position = UDim2.new(0.587,0,0.39,0)
    RGBTitle.Size = UDim2.new(0,100,0,16)
    ...
    local _, COLORPICKER_RInput = createValueInput("R", UDim2.new(0.587,0,0.44,0), COLORPICKER_MainFrame)
    local _, COLORPICKER_GInput = createValueInput("G", UDim2.new(0.717,0,0.44,0), COLORPICKER_MainFrame)
    local _, COLORPICKER_BInput = createValueInput("B", UDim2.new(0.847,0,0.44,0), COLORPICKER_MainFrame)

    local HSVTitle = Instance.new("TextLabel")
    HSVTitle.Parent = COLORPICKER_MainFrame
    HSVTitle.BackgroundTransparency = 1
    HSVTitle.Position = UDim2.new(0.587,0,0.61,0)
    HSVTitle.Size = UDim2.new(0,100,0,16)
    ...
    local _, COLORPICKER_HInput = createValueInput("H", UDim2.new(0.587,0,0.66,0), COLORPICKER_MainFrame)
    local _, COLORPICKER_SInput = createValueInput("S", UDim2.new(0.717,0,0.66,0), COLORPICKER_MainFrame)
    ...
    return {
        ...
        COLORPICKER_RInput = COLORPICKER_RInput,
        COLORPICKER_GInput = COLORPICKER_GInput,
        COLORPICKER_BInput = COLORPICKER_BInput,
        COLORPICKER_HInput = COLORPICKER_HInput,
        COLORPICKER_SInput = COLORPICKER_SInput,
        COLORPICKER_VInput = COLORPICKER_VInput,
    }
end
...
local function buildNotificationsAndDemo(NotificationsGui, TABS_TabsBg, MAIN_TabsContentFolder)
    ...
    NOTIFICATIONS_MainFrame.Size = UDim2.new(0,253,0,74)
    NOTIFICATIONS_MainFrame.ZIndex = 1
    NOTIFICATIONS_MainFrame.ClipsDescendants = true
    ...
    NOTIFICATIONS_NotificationName.Size = UDim2.new(0,150,0,23)
...
local function fadeOutGuiTree(root, duration)
	...
	for _, obj in ipairs(objects) do
		if obj:IsA("Frame") or obj:IsA("ScrollingFrame") or obj:IsA("ViewportFrame") then
			tween(obj, info, {BackgroundTransparency = 1})
		elseif obj:IsA("ImageLabel") or obj:IsA("ImageButton") then
			tween(obj, info, {BackgroundTransparency = 1, ImageTransparency = 1})
		elseif obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
			tween(obj, info, {BackgroundTransparency = 1, TextTransparency = 1, TextStrokeTransparency = 1})
		elseif obj:IsA("UIStroke") then
			tween(obj, info, {Transparency = 1})
		end
	end
end
...
DropdownItems.Size = UDim2.new(1, 0, 1, -38)
...
local function openDropdown(binding)
	...
	local targetHeight = math.clamp(contentHeight + 36, 70, binding.MaxHeight or 220)
	...
	if targetX + 240 > viewport.X - 10 then
		targetX = math.max(10, viewport.X - 250)
	end
...
local updateColorPickerVisuals
local syncColorPickerFromColor
local commitCurrentColor
local colorFieldsGuard = false

local function updateColorFields()
	if colorFieldsGuard then
		return
	end
	colorFieldsGuard = true
...
local function applyInputsToColor(kind)
	if colorFieldsGuard then
		return
	end
	if kind == "RGB" then
...
syncColorPickerFromColor = function(color)
...
commitCurrentColor = function(pushHistory)
		...
		if active then
			if instant then
				...
				if state then
					...
					tween(active, DEFAULT_TWEEN, {Size = UDim2.fromOffset(0, 0), BackgroundTransparency = 1})
					task.delay(0.18, function()
						if active and not state then
...
function Amphibia.BindSlider(sliderButton, config)
	...
	local valueBox = sliderButton:FindFirstChild("ValueBox") or sliderButton:FindFirstChildOfClass("TextBox")
...
for _, info in ipairs(tabData) do
	...
	info.Button.AutoButtonColor = false
	info.Button.MouseEnter:Connect(function()
		if currentTabButton ~= info.Button then
			tween(info.Button, DEFAULT_TWEEN, {TextColor3 = Color3.fromRGB(188,188,188)})
		end
	end)
	...
	for _, info in ipairs(tabData) do
		...
		if selected then
			...
			if info.Button:IsA("TextButton") then
				tween(info.Button, DEFAULT_TWEEN, {TextColor3 = Color3.fromRGB(153, 70, 255)})
			end
		else
			if info.Button:IsA("TextButton") then
				tween(info.Button, DEFAULT_TWEEN, {TextColor3 = Color3.fromRGB(255,255,255)})
...
local function layoutNotificationFrame(frame)
	if not frame then
		return
	end
